...
from tensorlayer.layers import InputLayer, Conv2d, BatchNormLayer, ElementwiseLayer,SubpixelConv2d,FlattenLayer,DenseLayer,MaxPool2d
import time
...
def SRGAN_g(t_image, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        n = Conv2d(n, 3, (1, 1), (1, 1), act=tf.nn.tanh, padding='SAME', W_init=w_init, b_init=b_init, name='out')
        return n
